...
while True:
    ...
    for i in hs300_data.index:
        ...
        # flag = hs300_close < hs300_ma30 and ((hs300_vol > hs300_ma_v_120) and (hs300_ma_v_30 > hs300_vol))
        # flag = hs300_close > hs300_ma20
        # flag = hs300_close > min(hs300_ma10, hs300_ma20)
        # flag = hs300_close > min(hs300_ma20, hs300_ma30)
        # flag = hs300_close > max(hs300_ma10, hs300_ma20, hs300_ma30)
        # flag = hs300_ma_v_30 > hs300_ma_v_120
        # flag = hs300_close > hs300_ma20 and hs300_vol > hs300_ma_v_120
        # flag = hs300_close > hs300_ma20 and hs300_ma_v_30 > hs300_ma_v_120
        flag = hs300_close > hs300_ma20 and hs300_ma_v_30 > hs300_ma_v_120 and hs300_vol > hs300_ma_v_120
        # flag = hs300_ma30 < hs300_ma20 and hs300_ma20 < hs300_close and hs300_ma_v_30 < hs300_ma_v_120 and hs300_ma_v_120 < hs300_vol
        ...
        if len(in_stock_dict) > 0:
            ...
            for stock_code in ls:
                ...
                # if stock_close > max(stock_ma20, stock_ma30):
                    # if stock_close > min(stock_ma20,stock_ma30):
                    # if stock_close > stock_ma30 or stock_close > stock_ma20:
                    continue
                else:
        ...
        if flag and len(in_stock_dict) < max_stock:
            ...
            for key in data.keys():
                ...
                if pre_close < pre_ma20 and ma_20<close and not bar_stop and close / pre_close <= 1.05 and vol<ma_v_30 and ma_v_30 < ma_v_120:
                    # if pre_close < pre_ma20 and close > ma_20 and not bar_stop and change > 0 and vol > pre_vol and close / pre_close <= 1.05:
                    # if pre_close < pre_ma30 and close > ma_30 and not bar_stop and change > 0 and vol > pre_vol and vol > ma_v_120 and close / pre_close <= 1.05:
                    # if pre_close < pre_ma20 and close > min(ma_20,ma_30) and not bar_stop and change > 0 and vol > max(pre_vol,ma_v_120) and close / pre_close <= 1.05:
                    # if pre_close < pre_ma20 and close > ma_20 and not bar_stop and change > 0 and vol > pre_vol and vol > ma_v_120 and ma_v_30 > ma_v_120 and close / pre_close <= 1.05:
                    # if pre_close < pre_ma30 and close > ma_30 and not bar_stop and change > 0 and vol > pre_vol and vol > ma_v_120 and ma_v_30 > ma_v_120 and close / pre_close <= 1.05:
